...
class FlickrSlideshow {
    ...
    public function fshow( $atts ) {
        ...
        $return .= '<iframe src="'.$this->get_url($user_id,$atts['photosetid'],$atts['username']).'" style="width: 100%; height: '.$atts['height'].'px" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true">'."\n";
        $return .= '</iframe>'."\n";
        $return .= '<noframes>'."\n";
        $return .= $simpleLink;
        $return .= '</noframes>'."\n";
